...
impl Model {
    fn switch_main() -> Render<AppRoute, ()> {
        Router::render(|switch: AppRoute| match switch {
            ...
            AppRoute::Article1 => Self::page(html! {<Article1/>}),
            AppRoute::Article2 => Self::page(html! {<Article2/>}),
    ...
    fn page(html: Html) -> Html {
        let sidebar = html_nested! {
            <PageSidebar>
                <Nav>
                    <NavRouterItem<AppRoute> to={AppRoute::Index}>{"About Me"}</NavRouterItem<AppRoute>>
                    <NavRouterExpandable<AppRoute> title="2022">
                        <NavRouterItem<AppRoute> to={AppRoute::Article1}>{"Article 1"}</NavRouterItem<AppRoute>>
                        <NavRouterItem<AppRoute> to={AppRoute::Article2}>{"Article 2"}</NavRouterItem<AppRoute>>
        ...
        let logo = html_nested! {
            <Logo src="https://spichugi.fedorapeople.org/bloglogo.png" alt="Simon's Blog Logo" />
        };
